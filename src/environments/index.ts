...
const PORT: number = +process.env.PORT || 16036
...
// jsonwebtoken
const ISSUER: string = process.env.ISSUER || 'Acexis corp'
const AUDIENCE: string = process.env.AUDIENCE || 'xxx'
...
// nodemailer
const NODEMAILER_USER: string = process.env.NODEMAILER_USER || 'nguyentam2112015@gmail.com'
const NODEMAILER_PASS: string = process.env.NODEMAILER_PASS || 'nguyenthientam'
